...
### Added
- Example code demonstrating main features for pub.dev Example tab
...
- Dart-native packages:
  ...
  - `xml` (^6.4.0) for XML generation
  - `http` (^1.1.0) for network requests
  - `crypto` (^3.0.3) for hashing
  - `charset` (^2.0.1) for encoding detection
...
- Ported by [@kamranxdev](https://github.com/kamranxdev) (Kamran Khan)
- Based on the original Python library by [Adrien Barbaresi](https://github.com/adbar)
